...
pub fn syscall(syscall_id: usize, args: [usize; 6]) -> isize {
    match syscall_id {
        SYSCALL_SHUTDOWN => shutdown(true),
        ...
        SYSCALL_UNLINKAT => sys_unlink(args[0] as isize, args[1] as *const u8, args[2] as u32),
        ...
        SYSCALL_UNAME => sys_uname(args[0] as *mut UNAME),
        SYSCALL_TIMES => sys_get_times(args[0] as *mut u64),
        SYSCALL_GET_TIME => sys_get_time_of_day(args[0] as *mut u64),
